...
public class Uploadbutton extends JPanel{
    private static final Color BACKGROUND_COLOR = new Color(0x1d1d1d);
    private static final Color SEARCH_BACKGROUND_COLOR = new Color(0x5271FF);
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw search bar
        int searchBarWidth = 445;
        int searchBarHeight = 50;
        int searchBarY = SEARCH_PADDING;

        RoundRectangle2D searchBarShape = new RoundRectangle2D.Float(545, 
                searchBarY, searchBarWidth,
